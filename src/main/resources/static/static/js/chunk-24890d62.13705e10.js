    ...
    ac87: function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                attrs: {placeholder: "请输入班级名称"}, model: {
                    value: e.form.name, callback: function (t) {
                        e.$set(e.form, "name", t)
                    }, expression: "form.name"
                }
            })], 1), a("el-form-item", {attrs: {label: "班级人数", prop: "number"}}, [a("el-input", {
                attrs: {
                    type: "number",
                    placeholder: "请输入班级人数"
                }, model: {
                ...
                attrs: {placeholder: "请输入班主任邮箱"}, model: {
            ...
            name: "ClazzManage", data: function () {
                return {
                    ...
                    rules: {
                        ...
                        headmaster: [{required: !0, message: "请输入班主任姓名"}, {min: 2, message: "班主任姓名不能小于2位"}],
                        email: [{required: !0, message: "请输入班主任邮箱"}, {type: "email", message: "不是合法的邮箱格式"}],
                        telephone: [{required: !0, message: "请输入班主任电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        gradeName: [{required: !0, message: "请选择所属年级"}],
                        introduction: [{required: !0, message: "请输入班级介绍"}, {min: 10, message: "班级介绍至少10位"}]
                    }
                }
            }, mounted: function () {
