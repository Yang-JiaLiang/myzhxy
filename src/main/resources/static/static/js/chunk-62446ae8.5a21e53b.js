    ...
    "2fa5": function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                attrs: {placeholder: "请输入年级名称"}, model: {
                ...
                attrs: {placeholder: "请输入年级主任"}, model: {
                ...
                attrs: {placeholder: "请输入主任邮箱"}, model: {
            ...
            name: "GradeManage", data: function () {
                return {
                    ...
                    rules: {
                        ...
                        email: [{required: !0, message: "请输入主任邮箱"}, {type: "email", message: "不是合法的邮箱格式"}],
                        telephone: [{required: !0, message: "请输入主任电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        introduction: [{required: !0, message: "请输入年级介绍"}, {min: 10, message: "年级介绍至少10位"}]
                    }
                }
            }, mounted: function () {
                this.getList()
